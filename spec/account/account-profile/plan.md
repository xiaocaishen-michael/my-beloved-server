...
- [`spec/account/phone-sms-auth/`](../phone-sms-auth/) — auth 上游 use case（响应 schema 不可变约束的来源）
- 前端配套 plan：[`apps/native/spec/onboarding/plan.md`](https://github.com/xiaocaishen-michael/no-vain-years-app/blob/main/apps/native/spec/onboarding/plan.md)
