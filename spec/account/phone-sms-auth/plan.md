...
- [`spec/account/account-state-machine.md`](../account-state-machine.md)（同 PR 加 "Auto-create on phone-sms-auth" 段）
- 历史 spec：`spec/account/{register-by-phone,login-by-phone-sms,login-by-password}/`（各加 SUPERSEDED.md）
