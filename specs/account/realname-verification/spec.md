...
> **下游 / 关联**：
>
> - 前端 spec：[`apps/native/specs/realname/`](https://github.com/xiaocaishen-michael/no-vain-years-app/tree/main/apps/native/spec/realname)（待开 PR；按 ADR-0017 类 1 标准 UI 流程：业务流先行，mockup 后置）
...
- 前端 spec：[`apps/native/specs/realname/`](https://github.com/xiaocaishen-michael/no-vain-years-app/tree/main/apps/native/spec/realname)（待开 PR）
- 既有参考 spec：[`specs/account/phone-sms-auth/`](../phone-sms-auth/) — 结构参照
